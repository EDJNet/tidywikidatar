...
#'
#' @return A character vector, with the Wikidata label in the requested
#'   language.
#' @export
#'
#' @examples
...
#' Get label of a Wikidata property in a given language
#'
#' @param property A character vector of length 1, must start with P, e.g.
#'   "P31".
#' @inheritParams tw_get
#' @inheritParams tw_search
#' @inheritParams tw_get_property
#'
#' @return A character vector of length 1, with the Wikidata label in the
#'   requested language.
#'
#' @examples
