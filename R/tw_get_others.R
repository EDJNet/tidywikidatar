...
#'
#' @param id A character vector, must start with Q, e.g. "Q254" for Wolfgang
#'   Amadeus Mozart
...
#'   Wikidata. Wait time is not applied to contents retrieved from the local
#'   cache. If you are running a large number of queries systematically you may
